...
- Recordings of the sessions of the MapTask are available to academic researchers upon request to the authors. They are in the form of a folder, where each sub-folder contains audio files and corresponding ELAN files that contain the transcription of the audio in Chinese characters (both non-segmented and manually segmented) and jyutping romanization.
